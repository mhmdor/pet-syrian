...
<body>
    ...
    <main id="main">
        ...
        @if (\Session::has('message'))
            <div class="alert alert-success text-center" id="success-alert">
                <strong>Success ! </strong> Animals has added to your Favorite.
            </div>
        @endif
                    ...
                    @if ($ads->count() > 0)
                        @foreach ($ads as $ad)
                            <div class="col-lg-4 col-md-6  portfolio-item filter-{{ $ad->type }}">
                                ...
                                <a href="{{ url('ads/liked/' . $ad->id) }}"><span style="box-shadow: 2px 2px 3px rgb(0, 0, 0);
          visibility: visible;
          font-weight: bold;
    ...
    <a data-bs-toggle="modal" data-bs-target="#staticBackdrop1" class="float">
