    ...
    <div class="container-contact100">
        ...
        <div class="wrap-contact100">
            ...
            <div id="myModal" class="modal fade">
             ...
             @endif
             <form method="POST" class="contact100-form validate-form" action="{{ route('ads.store') }} "
                ...
                <div class="wrap-input100 validate-input" data-validate="Name is required">
                    <span class="label-input100">{{ __('messages.namanm') }}</span>
                    <input class="input100 " type="text" name="title" placeholder="{{ __('messages.namanm') }}">
                    @error('title')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                    <span class="focus-input100"></span>
                ...
                <div class="wrap-input100 validate-input" data-validate="photo is required">
                    ...
                    <br>
                    <input class="input100 " accept="image/*" type="file" name="photo" id="img" />
                ...
                <div class="wrap-input100 " >
                    ...
                    <input class="input100 " accept="image/*" type="file" id="images" name="images[]" placeholder="photo " multiple>
                    @error('photo')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                    <span class="focus-input100"></span>
                ...
                <span class="contact100-form-title">
                  <h3>{{ __('messages.minfo') }} </h3> 
                </span>
                <div class="wrap-input100 " >
                    <span class="label-input100">{{ __('messages.ageanm') }}</span>
                    <input class="input100 " type="text" name="old" placeholder="{{ __('messages.ageanm') }}">
                    @error('old')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                    <span class="focus-input100"></span>
                ...
                <div class="wrap-input100 " >
                    <span class="label-input100">{{ __('messages.con') }} </span>
                    <input class="input100 " type="text" name="country" placeholder="{{ __('messages.conanm') }}">
                    @error('country')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                    <span class="focus-input100"></span>
                ...
                <div class="wrap-input100 " >
                    <span class="label-input100"> {{ __('messages.passport') }} </span>
                    <input class="input100 " type="file" name="images_p[]" placeholder="{{ __('messages.passport') }} " multiple>
                    @error('photo')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                    <span class="focus-input100"></span>
