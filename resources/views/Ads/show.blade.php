...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      <h1 class="logo me-auto"><a href="{{route('home')}}" >Pet Syrian <img  src="{{asset('assets/img/animals/logo.jpg')}}" class="img-fluid" alt=""></a></h1>
     

      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>

          <li class="dropdown"><a href=""><span>{{__('messages.language')}}</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
...
{{--             
          <li class="dropdown"><a href=""><span>{{__('messages.about')}}</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
 ...
 --}}
          ...
          <li class="dropdown"><a href=""><span>{{__('messages.Categories')}}</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="{{route('ads.alltype',['type'=>'Cat'])}}">{{__('messages.cat')}}</a></li>
              <li><a href="{{route('ads.alltype',['type'=>'Dog'])}}">{{__('messages.dog')}}</a></li>
              <li><a href="{{route('ads.alltype',['type'=>'Bird'])}}">{{__('messages.bird')}}</a></li>
              <li><a href="{{route('ads.alltype',['type'=>'Horse'])}}">{{__('messages.horse')}}</a></li>
              <li><a href="{{route('ads.alltype',['type'=>'Breeding'])}}">{{__('messages.Breeding')}}</a></li>

           
              <li><a href="{{route('ads.alltype',['type'=>'Others'])}}">{{__('messages.Others')}}</a></li>
            </ul>
          </li>
          <li><a href="{{route('ads.alltype',['type'=>'Accessories'])}}">{{__('messages.Accessories')}}</a></li>
          @guest
          <li class="nav-item">
...
<a type="button" class="btn " data-bs-toggle="modal" data-bs-target="#staticBackdrop1">
  {{__('messages.newads')}}
          ...
          <li class="dropdown"><a id="navbarDropdown" class="" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
           ...
           <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li>
                <a a class="dropdown-item" href="{{ route('profile') }}">{{__('messages.MyProfile')}}</a>
                <a href="{{route('ads.myADS')}}" class="dropdown-item">{{__('messages.MyADs')}}   </a>
                <a href="{{route('ads.getfav')}}" class="dropdown-item">{{__('messages.MyFAV')}}   </a>
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-body text-center">
      <a style="background: #10a01c;color:rgb(255, 255, 255);margin-bottom:12px;"  class="btn  btn-lg" href="{{ route('ads.create') }}">{{__('messages.newadsanimals')}}</a>
      <a style="background: #10a01c;color:rgb(255, 255, 255)"   class="btn  btn-lg" href="{{ route('ads.createAccessories') }}">{{__('messages.newadsacss')}}</a>
    </div>
